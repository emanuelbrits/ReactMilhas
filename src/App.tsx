...
function App() {
  ...
  return (
    <>
      ...
      {bonus > 0 && <p>Na compra de {qtd_milhas} milhas, você receberá mais {qtd_milhas * (bonus / 100)}. <br />O preço real do milheiro cai para R$ {((preco_milheiro) / ((qtd_milhas) + (qtd_milhas / (bonus / 100)))).toFixed(2)}</p>}
