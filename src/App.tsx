...
function App() {
  ...
  const preco_real = ((preco_milheiro * (qtd_milhas / 1000)) / ((qtd_milhas + (qtd_milhas * (bonus / 100))) / 1000))
  ...
  return (
    <>
      ...
      {bonus > 0 && <p>Na compra de {qtd_milhas} milhas, você receberá mais {qtd_milhas * (bonus / 100)}. <br />O preço real do milheiro cai para R$ {preco_real.toFixed(2)}</p>}
